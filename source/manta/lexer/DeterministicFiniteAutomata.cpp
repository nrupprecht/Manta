...
inline std::vector<std::pair<int, int>> FiniteAutomaton::acceptingStateLambda(const unsigned index) {
  ...
  std::sort(accepting_states.begin(), accepting_states.end(), std::greater<std::pair<int, int>>{});
