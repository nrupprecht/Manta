...
//    bool LALRParser::createParserFromFile(const string& fileName) {
//        std::ifstream fin(fileName);
//        if (fin.fail()) {
//            return false;
//        }
//        createParserFromFile(fin);
//        fin.close();
//        return true;
//    }
//
//    bool LALRParser::createParserFromFile(std::istream& stream) {
//        char c;
...
//
//    inline void LALRParser::getProductions(std::istream& in, int production_id) {
...
//    }
//
//    inline std::shared_ptr<ParseNode> LALRParser::getInstructions(std::istream& in, int pid) {
//        // Setup.
//        char c;
//        string acc;
...
//    }
//
//    inline int LALRParser::registerProduction(const string& production) {
...
//    }
//
//    inline void LALRParser::shiftProductionNumbers() {
...
//    }
//
//    int LALRParser::addState(const State& items) {
...
//    }
//
//    void LALRParser::computeGoto(int s) {
...
//    }
//
//    State LALRParser::closure(int s) {
//        // Initialize ans.
...
//    }
//
//    State LALRParser::advanceDot(const State& state, int symb) {
...
//    }
//
//    void LALRParser::assertEntry(int state, int symbol, const Entry& action) {
...
//    }
//
//    void LALRParser::computeLookahead() {
//        /* Used in LALR(1) parser */
//    }
//
//    void LALRParser::tryRuleInState(int state, const Item& rule) {
...
//    }
//
//    inline int LALRParser::findState(const State& items) {
//        int s = 0;
