//============================================================================
// Code automatically generated by Manta at time 2024-11-19 22:20:41.115555.
//
//============================================================================
...
struct ParserGenerator
  ...
  void Visit(ASTNode_Lexeme& object) override {
    switch (object.item_id) {
      case 8: {
        LOG_SEV(Debug) << "Adding lexeme: " << object.name << " with regex " << object.regex;
        std::string_view name = object.name;
        name = name.substr(1, name.size() - 1);  // Remove the @
        production_rules_data_->lexer_generator->AddLexeme(std::string(name), object.regex);
        break;
      }
      default: {};
    }
  ...
  void Visit(ASTNode_parser& object) override {
    switch (object.item_id) {
      case 16: {
        ...
        LOG_SEV(Debug) << "Registered nonterminal " << object.nonterminal_name << " with id " << current_production_id_;
  ...
  void Visit(ASTNode_literal& object) override {
    switch (object.item_id) {
      case 25: {
        ...
        LOG_SEV(Info) << "Literal: " << CLBG(object.literal) << "', id = " << id << ".";
        current_item_.AddToProduction(id);
        break;
      }
      default: {};
  ...
  void Visit(ASTNode_lexeme_name& object) override {
    switch (object.item_id) {
      case 26: {
        LOG_SEV(Info) << "Lexeme name: '" << object.lexeme_name << "'";
        int id = getLexemeID(object.lexeme_name);
        current_item_.AddToProduction(id);
        break;
      }
      default: {};
