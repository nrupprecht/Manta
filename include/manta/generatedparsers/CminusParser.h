...
#define REDUCE_ASSERT(count, item, size)                                                                  \
  MANTA_REQUIRE(count <= size,                                                                            \
                "in reduction " #item ", not enough nodes in the collect vector, needed at least " #count \
                ", actual size was "                                                                      \
                    << size)
...
struct ASTLexeme : ASTNodeBase {
  explicit ASTLexeme(const std::string& literal)
      : ASTNodeBase(ASTNodeType::Literal, NonterminalType::Terminal, -1)
      , literal(literal) {}
...
struct ASTNodeGeneral_23_parmTypeList : ASTNodeBase {
  explicit ASTNodeGeneral_23_parmTypeList(const ItemID& item_id)
      : ASTNodeBase(
            ASTNodeType::Type_ASTNodeGeneral_23_parmTypeList, NonterminalType::parmTypeList, item_id) {}
...
struct ASTNodeGeneral_36_compoundStmt : ASTNodeBase {
  explicit ASTNodeGeneral_36_compoundStmt(const ItemID& item_id)
      : ASTNodeBase(
            ASTNodeType::Type_ASTNodeGeneral_36_compoundStmt, NonterminalType::compoundStmt, item_id) {}
...
protected:
  ...
  std::shared_ptr<ASTNodeBase> reduce(unsigned reduction_id,
                                      const std::vector<std::shared_ptr<ASTNodeBase>>& collected_nodes);

  std::shared_ptr<ASTNodeGeneral_0_program> ReduceTo_ASTNodeGeneral_0_program_ViaItem_0(
      const std::shared_ptr<ASTNodeBase_declList>& argument_0);

  std::shared_ptr<ASTNodeGeneral_1_declList> ReduceTo_ASTNodeGeneral_1_declList_ViaItem_1(
      const std::shared_ptr<ASTNodeBase_declList>& argument_0,
      const std::shared_ptr<ASTNodeBase_decl>& argument_1);

  std::shared_ptr<ASTNodeGeneral_2_declList> ReduceTo_ASTNodeGeneral_2_declList_ViaItem_2(
      const std::shared_ptr<ASTNodeBase_decl>& argument_0);

  std::shared_ptr<ASTNodeGeneral_3_decl> ReduceTo_ASTNodeGeneral_3_decl_ViaItem_3(
      const std::shared_ptr<ASTNodeGeneral_5_varDecl>& argument_0);

  std::shared_ptr<ASTNodeGeneral_4_decl> ReduceTo_ASTNodeGeneral_4_decl_ViaItem_4(
      const std::shared_ptr<ASTNodeBase_funDecl>& argument_0);

  std::shared_ptr<ASTNodeGeneral_5_varDecl> ReduceTo_ASTNodeGeneral_5_varDecl_ViaItem_5(
  ...
  std::shared_ptr<ASTNodeGeneral_6_scopedVarDecl> ReduceTo_ASTNodeGeneral_6_scopedVarDecl_ViaItem_6(
  ...
  std::shared_ptr<ASTNodeGeneral_7_scopedVarDecl> ReduceTo_ASTNodeGeneral_7_scopedVarDecl_ViaItem_7(
      const std::shared_ptr<ASTNodeBase_typeSpec>& argument_0,
      const std::shared_ptr<ASTNodeBase_varDeclList>& argument_1,
      const std::string& argument_2);

  std::shared_ptr<ASTNodeGeneral_8_varDeclList> ReduceTo_ASTNodeGeneral_8_varDeclList_ViaItem_8(
  ...
  std::shared_ptr<ASTNodeGeneral_9_varDeclList> ReduceTo_ASTNodeGeneral_9_varDeclList_ViaItem_9(
      const std::shared_ptr<ASTNodeBase_varDeclInit>& argument_0);

  std::shared_ptr<ASTNodeGeneral_10_varDeclInit> ReduceTo_ASTNodeGeneral_10_varDeclInit_ViaItem_10(
      const std::shared_ptr<ASTNodeBase_varDeclId>& argument_0);

  std::shared_ptr<ASTNodeGeneral_11_varDeclInit> ReduceTo_ASTNodeGeneral_11_varDeclInit_ViaItem_11(
      const std::shared_ptr<ASTNodeBase_varDeclId>& argument_0,
      const std::string& argument_1,
      const std::shared_ptr<ASTNodeBase_simpleExp>& argument_2);

  std::shared_ptr<ASTNodeGeneral_12_varDeclId> ReduceTo_ASTNodeGeneral_12_varDeclId_ViaItem_12(
      const std::string& argument_0);

  std::shared_ptr<ASTNodeGeneral_13_varDeclId> ReduceTo_ASTNodeGeneral_13_varDeclId_ViaItem_13(
      const std::string& argument_0,
      const std::string& argument_1,
      const std::string& argument_2,
      const std::string& argument_3);

  std::shared_ptr<ASTNodeGeneral_14_typeSpec> ReduceTo_ASTNodeGeneral_14_typeSpec_ViaItem_14(
      const std::string& argument_0);

  std::shared_ptr<ASTNodeGeneral_15_typeSpec> ReduceTo_ASTNodeGeneral_15_typeSpec_ViaItem_15(
      const std::string& argument_0);

  std::shared_ptr<ASTNodeGeneral_16_typeSpec> ReduceTo_ASTNodeGeneral_16_typeSpec_ViaItem_16(
      const std::string& argument_0);

  std::shared_ptr<ASTNodeGeneral_17_funDecl> ReduceTo_ASTNodeGeneral_17_funDecl_ViaItem_17(
      const std::shared_ptr<ASTNodeBase_typeSpec>& argument_0,
      const std::string& argument_1,
      const std::string& argument_2,
  ...
  std::shared_ptr<ASTNodeGeneral_18_funDecl> ReduceTo_ASTNodeGeneral_18_funDecl_ViaItem_18(
      const std::string& argument_0,
      const std::string& argument_1,
  ...
  std::shared_ptr<ASTNodeGeneral_19_parms> ReduceTo_ASTNodeGeneral_19_parms_ViaItem_19(
      const std::shared_ptr<ASTNodeBase_parmList>& argument_0);

  std::shared_ptr<ASTNodeGeneral_20_parms> ReduceTo_ASTNodeGeneral_20_parms_ViaItem_20();

  std::shared_ptr<ASTNodeGeneral_21_parmList> ReduceTo_ASTNodeGeneral_21_parmList_ViaItem_21(
      const std::shared_ptr<ASTNodeBase_parmList>& argument_0,
      const std::string& argument_1,
      const std::shared_ptr<ASTNodeGeneral_23_parmTypeList>& argument_2);

  std::shared_ptr<ASTNodeGeneral_22_parmList> ReduceTo_ASTNodeGeneral_22_parmList_ViaItem_22(
      const std::shared_ptr<ASTNodeGeneral_23_parmTypeList>& argument_0);

  std::shared_ptr<ASTNodeGeneral_23_parmTypeList> ReduceTo_ASTNodeGeneral_23_parmTypeList_ViaItem_23(
      const std::shared_ptr<ASTNodeBase_typeSpec>& argument_0,
      const std::shared_ptr<ASTNodeBase_parmIdList>& argument_1);

  std::shared_ptr<ASTNodeGeneral_24_parmIdList> ReduceTo_ASTNodeGeneral_24_parmIdList_ViaItem_24(
      const std::shared_ptr<ASTNodeBase_parmIdList>& argument_0,
      const std::string& argument_1,
      const std::shared_ptr<ASTNodeBase_parmId>& argument_2);

  std::shared_ptr<ASTNodeGeneral_25_parmIdList> ReduceTo_ASTNodeGeneral_25_parmIdList_ViaItem_25(
      const std::shared_ptr<ASTNodeBase_parmId>& argument_0);

  std::shared_ptr<ASTNodeGeneral_26_parmId> ReduceTo_ASTNodeGeneral_26_parmId_ViaItem_26(
      const std::string& argument_0);

  std::shared_ptr<ASTNodeGeneral_27_parmId> ReduceTo_ASTNodeGeneral_27_parmId_ViaItem_27(
      const std::string& argument_0, const std::string& argument_1, const std::string& argument_2);

  std::shared_ptr<ASTNodeGeneral_28_stmt> ReduceTo_ASTNodeGeneral_28_stmt_ViaItem_28(
      const std::shared_ptr<ASTNodeBase_expStmt>& argument_0);

  std::shared_ptr<ASTNodeGeneral_29_stmt> ReduceTo_ASTNodeGeneral_29_stmt_ViaItem_29(
      const std::shared_ptr<ASTNodeGeneral_36_compoundStmt>& argument_0);

  std::shared_ptr<ASTNodeGeneral_30_stmt> ReduceTo_ASTNodeGeneral_30_stmt_ViaItem_30(
      const std::shared_ptr<ASTNodeBase_selectStmt>& argument_0);

  std::shared_ptr<ASTNodeGeneral_31_stmt> ReduceTo_ASTNodeGeneral_31_stmt_ViaItem_31(
      const std::shared_ptr<ASTNodeBase_iterStmt>& argument_0);

  std::shared_ptr<ASTNodeGeneral_32_stmt> ReduceTo_ASTNodeGeneral_32_stmt_ViaItem_32(
      const std::shared_ptr<ASTNodeBase_returnStmt>& argument_0);

  std::shared_ptr<ASTNodeGeneral_33_stmt> ReduceTo_ASTNodeGeneral_33_stmt_ViaItem_33(
      const std::shared_ptr<ASTNodeGeneral_49_breakStmt>& argument_0);

  std::shared_ptr<ASTNodeGeneral_34_expStmt> ReduceTo_ASTNodeGeneral_34_expStmt_ViaItem_34(
      const std::shared_ptr<ASTNodeBase_exp>& argument_0, const std::string& argument_1);

  std::shared_ptr<ASTNodeGeneral_35_expStmt> ReduceTo_ASTNodeGeneral_35_expStmt_ViaItem_35(
      const std::string& argument_0);

  std::shared_ptr<ASTNodeGeneral_36_compoundStmt> ReduceTo_ASTNodeGeneral_36_compoundStmt_ViaItem_36(
      const std::string& argument_0,
      const std::shared_ptr<ASTNodeBase_localDecls>& argument_1,
      const std::shared_ptr<ASTNodeBase_stmtList>& argument_2,
      const std::string& argument_3);

  std::shared_ptr<ASTNodeGeneral_37_localDecls> ReduceTo_ASTNodeGeneral_37_localDecls_ViaItem_37(
      const std::shared_ptr<ASTNodeBase_localDecls>& argument_0,
      const std::shared_ptr<ASTNodeBase_scopedVarDecl>& argument_1);

  std::shared_ptr<ASTNodeGeneral_38_localDecls> ReduceTo_ASTNodeGeneral_38_localDecls_ViaItem_38();

  std::shared_ptr<ASTNodeGeneral_39_stmtList> ReduceTo_ASTNodeGeneral_39_stmtList_ViaItem_39(
      const std::shared_ptr<ASTNodeBase_stmtList>& argument_0,
      const std::shared_ptr<ASTNodeBase_stmt>& argument_1);

  std::shared_ptr<ASTNodeGeneral_40_stmtList> ReduceTo_ASTNodeGeneral_40_stmtList_ViaItem_40();

  std::shared_ptr<ASTNodeGeneral_41_selectStmt> ReduceTo_ASTNodeGeneral_41_selectStmt_ViaItem_41(
      const std::string& argument_0,
      const std::shared_ptr<ASTNodeBase_simpleExp>& argument_1,
      const std::string& argument_2,
      const std::shared_ptr<ASTNodeBase_stmt>& argument_3);

  std::shared_ptr<ASTNodeGeneral_42_selectStmt> ReduceTo_ASTNodeGeneral_42_selectStmt_ViaItem_42(
      const std::string& argument_0,
      const std::shared_ptr<ASTNodeBase_simpleExp>& argument_1,
      const std::string& argument_2,
      const std::shared_ptr<ASTNodeBase_stmt>& argument_3,
  ...
  std::shared_ptr<ASTNodeGeneral_43_iterStmt> ReduceTo_ASTNodeGeneral_43_iterStmt_ViaItem_43(
      const std::string& argument_0,
      const std::shared_ptr<ASTNodeBase_simpleExp>& argument_1,
      const std::string& argument_2,
      const std::shared_ptr<ASTNodeBase_stmt>& argument_3);

  std::shared_ptr<ASTNodeGeneral_44_iterStmt> ReduceTo_ASTNodeGeneral_44_iterStmt_ViaItem_44(
      const std::string& argument_0,
      const std::string& argument_1,
      const std::string& argument_2,
  ...
  std::shared_ptr<ASTNodeGeneral_45_iterRange> ReduceTo_ASTNodeGeneral_45_iterRange_ViaItem_45(
      const std::shared_ptr<ASTNodeBase_simpleExp>& argument_0,
      const std::string& argument_1,
      const std::shared_ptr<ASTNodeBase_simpleExp>& argument_2);

  std::shared_ptr<ASTNodeGeneral_46_iterRange> ReduceTo_ASTNodeGeneral_46_iterRange_ViaItem_46(
      const std::shared_ptr<ASTNodeBase_simpleExp>& argument_0,
      const std::string& argument_1,
      const std::shared_ptr<ASTNodeBase_simpleExp>& argument_2,
      const std::string& argument_3,
  ...
  std::shared_ptr<ASTNodeGeneral_47_returnStmt> ReduceTo_ASTNodeGeneral_47_returnStmt_ViaItem_47(
      const std::string& argument_0, const std::string& argument_1);

  std::shared_ptr<ASTNodeGeneral_48_returnStmt> ReduceTo_ASTNodeGeneral_48_returnStmt_ViaItem_48(
      const std::string& argument_0,
      const std::shared_ptr<ASTNodeBase_exp>& argument_1,
      const std::string& argument_2);

  std::shared_ptr<ASTNodeGeneral_49_breakStmt> ReduceTo_ASTNodeGeneral_49_breakStmt_ViaItem_49(
      const std::string& argument_0, const std::string& argument_1);

  std::shared_ptr<ASTNodeGeneral_50_exp> ReduceTo_ASTNodeGeneral_50_exp_ViaItem_50(
      const std::shared_ptr<ASTNodeBase_mutable>& argument_0,
      const std::string& argument_1,
      const std::shared_ptr<ASTNodeBase_exp>& argument_2);

  std::shared_ptr<ASTNodeGeneral_51_exp> ReduceTo_ASTNodeGeneral_51_exp_ViaItem_51(
      const std::shared_ptr<ASTNodeBase_mutable>& argument_0,
      const std::string& argument_1,
      const std::shared_ptr<ASTNodeBase_exp>& argument_2);

  std::shared_ptr<ASTNodeGeneral_52_exp> ReduceTo_ASTNodeGeneral_52_exp_ViaItem_52(
      const std::shared_ptr<ASTNodeBase_mutable>& argument_0,
      const std::string& argument_1,
      const std::shared_ptr<ASTNodeBase_exp>& argument_2);

  std::shared_ptr<ASTNodeGeneral_53_exp> ReduceTo_ASTNodeGeneral_53_exp_ViaItem_53(
      const std::shared_ptr<ASTNodeBase_mutable>& argument_0,
      const std::string& argument_1,
      const std::shared_ptr<ASTNodeBase_exp>& argument_2);

  std::shared_ptr<ASTNodeGeneral_54_exp> ReduceTo_ASTNodeGeneral_54_exp_ViaItem_54(
      const std::shared_ptr<ASTNodeBase_mutable>& argument_0,
      const std::string& argument_1,
      const std::shared_ptr<ASTNodeBase_exp>& argument_2);

  std::shared_ptr<ASTNodeGeneral_55_exp> ReduceTo_ASTNodeGeneral_55_exp_ViaItem_55(
      const std::shared_ptr<ASTNodeBase_mutable>& argument_0, const std::string& argument_1);

  std::shared_ptr<ASTNodeGeneral_56_exp> ReduceTo_ASTNodeGeneral_56_exp_ViaItem_56(
      const std::shared_ptr<ASTNodeBase_mutable>& argument_0, const std::string& argument_1);

  std::shared_ptr<ASTNodeGeneral_57_exp> ReduceTo_ASTNodeGeneral_57_exp_ViaItem_57(
      const std::shared_ptr<ASTNodeBase_simpleExp>& argument_0);

  std::shared_ptr<ASTNodeGeneral_58_simpleExp> ReduceTo_ASTNodeGeneral_58_simpleExp_ViaItem_58(
      const std::shared_ptr<ASTNodeBase_simpleExp>& argument_0,
      const std::string& argument_1,
      const std::shared_ptr<ASTNodeBase_andExp>& argument_2);

  std::shared_ptr<ASTNodeGeneral_59_simpleExp> ReduceTo_ASTNodeGeneral_59_simpleExp_ViaItem_59(
      const std::shared_ptr<ASTNodeBase_andExp>& argument_0);

  std::shared_ptr<ASTNodeGeneral_60_andExp> ReduceTo_ASTNodeGeneral_60_andExp_ViaItem_60(
      const std::shared_ptr<ASTNodeBase_andExp>& argument_0,
      const std::string& argument_1,
      const std::shared_ptr<ASTNodeBase_unaryRelExp>& argument_2);

  std::shared_ptr<ASTNodeGeneral_61_andExp> ReduceTo_ASTNodeGeneral_61_andExp_ViaItem_61(
      const std::shared_ptr<ASTNodeBase_unaryRelExp>& argument_0);

  std::shared_ptr<ASTNodeGeneral_62_unaryRelExp> ReduceTo_ASTNodeGeneral_62_unaryRelExp_ViaItem_62(
      const std::string& argument_0, const std::shared_ptr<ASTNodeBase_unaryRelExp>& argument_1);

  std::shared_ptr<ASTNodeGeneral_63_unaryRelExp> ReduceTo_ASTNodeGeneral_63_unaryRelExp_ViaItem_63(
      const std::shared_ptr<ASTNodeBase_relExp>& argument_0);

  std::shared_ptr<ASTNodeGeneral_64_relExp> ReduceTo_ASTNodeGeneral_64_relExp_ViaItem_64(
  ...
  std::shared_ptr<ASTNodeGeneral_65_relExp> ReduceTo_ASTNodeGeneral_65_relExp_ViaItem_65(
      const std::shared_ptr<ASTNodeBase_minmaxExp>& argument_0);

  std::shared_ptr<ASTNodeGeneral_66_relop> ReduceTo_ASTNodeGeneral_66_relop_ViaItem_66(
      const std::string& argument_0);

  std::shared_ptr<ASTNodeGeneral_67_relop> ReduceTo_ASTNodeGeneral_67_relop_ViaItem_67(
      const std::string& argument_0);

  std::shared_ptr<ASTNodeGeneral_68_relop> ReduceTo_ASTNodeGeneral_68_relop_ViaItem_68(
      const std::string& argument_0);

  std::shared_ptr<ASTNodeGeneral_69_relop> ReduceTo_ASTNodeGeneral_69_relop_ViaItem_69(
      const std::string& argument_0);

  std::shared_ptr<ASTNodeGeneral_70_relop> ReduceTo_ASTNodeGeneral_70_relop_ViaItem_70(
      const std::string& argument_0);

  std::shared_ptr<ASTNodeGeneral_71_relop> ReduceTo_ASTNodeGeneral_71_relop_ViaItem_71(
      const std::string& argument_0);

  std::shared_ptr<ASTNodeGeneral_72_minmaxExp> ReduceTo_ASTNodeGeneral_72_minmaxExp_ViaItem_72(
      const std::shared_ptr<ASTNodeBase_minmaxExp>& argument_0,
      const std::shared_ptr<ASTNodeBase_minmaxop>& argument_1,
      const std::shared_ptr<ASTNodeBase_sumExp>& argument_2);

  std::shared_ptr<ASTNodeGeneral_73_minmaxExp> ReduceTo_ASTNodeGeneral_73_minmaxExp_ViaItem_73(
      const std::shared_ptr<ASTNodeBase_sumExp>& argument_0);

  std::shared_ptr<ASTNodeGeneral_74_minmaxop> ReduceTo_ASTNodeGeneral_74_minmaxop_ViaItem_74(
      const std::string& argument_0);

  std::shared_ptr<ASTNodeGeneral_75_minmaxop> ReduceTo_ASTNodeGeneral_75_minmaxop_ViaItem_75(
      const std::string& argument_0);

  std::shared_ptr<ASTNodeGeneral_76_sumExp> ReduceTo_ASTNodeGeneral_76_sumExp_ViaItem_76(
      const std::shared_ptr<ASTNodeBase_sumExp>& argument_0,
      const std::shared_ptr<ASTNodeBase_sumop>& argument_1,
      const std::shared_ptr<ASTNodeBase_mulExp>& argument_2);

  std::shared_ptr<ASTNodeGeneral_77_sumExp> ReduceTo_ASTNodeGeneral_77_sumExp_ViaItem_77(
      const std::shared_ptr<ASTNodeBase_mulExp>& argument_0);

  std::shared_ptr<ASTNodeGeneral_78_sumop> ReduceTo_ASTNodeGeneral_78_sumop_ViaItem_78(
      const std::string& argument_0);

  std::shared_ptr<ASTNodeGeneral_79_sumop> ReduceTo_ASTNodeGeneral_79_sumop_ViaItem_79(
      const std::string& argument_0);

  std::shared_ptr<ASTNodeGeneral_80_mulExp> ReduceTo_ASTNodeGeneral_80_mulExp_ViaItem_80(
      const std::shared_ptr<ASTNodeBase_mulExp>& argument_0,
      const std::shared_ptr<ASTNodeBase_mulop>& argument_1,
      const std::shared_ptr<ASTNodeBase_unaryExp>& argument_2);

  std::shared_ptr<ASTNodeGeneral_81_mulExp> ReduceTo_ASTNodeGeneral_81_mulExp_ViaItem_81(
      const std::shared_ptr<ASTNodeBase_unaryExp>& argument_0);

  std::shared_ptr<ASTNodeGeneral_82_mulop> ReduceTo_ASTNodeGeneral_82_mulop_ViaItem_82(
      const std::string& argument_0);

  std::shared_ptr<ASTNodeGeneral_83_mulop> ReduceTo_ASTNodeGeneral_83_mulop_ViaItem_83(
      const std::string& argument_0);

  std::shared_ptr<ASTNodeGeneral_84_mulop> ReduceTo_ASTNodeGeneral_84_mulop_ViaItem_84(
      const std::string& argument_0);

  std::shared_ptr<ASTNodeGeneral_85_unaryExp> ReduceTo_ASTNodeGeneral_85_unaryExp_ViaItem_85(
      const std::shared_ptr<ASTNodeBase_unaryop>& argument_0,
      const std::shared_ptr<ASTNodeBase_unaryExp>& argument_1);

  std::shared_ptr<ASTNodeGeneral_86_unaryExp> ReduceTo_ASTNodeGeneral_86_unaryExp_ViaItem_86(
      const std::shared_ptr<ASTNodeBase_factor>& argument_0);

  std::shared_ptr<ASTNodeGeneral_87_unaryop> ReduceTo_ASTNodeGeneral_87_unaryop_ViaItem_87(
      const std::string& argument_0);

  std::shared_ptr<ASTNodeGeneral_88_unaryop> ReduceTo_ASTNodeGeneral_88_unaryop_ViaItem_88(
      const std::string& argument_0);

  std::shared_ptr<ASTNodeGeneral_89_unaryop> ReduceTo_ASTNodeGeneral_89_unaryop_ViaItem_89(
      const std::string& argument_0);

  std::shared_ptr<ASTNodeGeneral_90_factor> ReduceTo_ASTNodeGeneral_90_factor_ViaItem_90(
      const std::shared_ptr<ASTNodeBase_immutable>& argument_0);

  std::shared_ptr<ASTNodeGeneral_91_factor> ReduceTo_ASTNodeGeneral_91_factor_ViaItem_91(
      const std::shared_ptr<ASTNodeBase_mutable>& argument_0);

  std::shared_ptr<ASTNodeGeneral_92_mutable> ReduceTo_ASTNodeGeneral_92_mutable_ViaItem_92(
      const std::string& argument_0);

  std::shared_ptr<ASTNodeGeneral_93_mutable> ReduceTo_ASTNodeGeneral_93_mutable_ViaItem_93(
      const std::string& argument_0,
      const std::string& argument_1,
      const std::shared_ptr<ASTNodeBase_exp>& argument_2,
      const std::string& argument_3);

  std::shared_ptr<ASTNodeGeneral_94_immutable> ReduceTo_ASTNodeGeneral_94_immutable_ViaItem_94(
      const std::string& argument_0,
      const std::shared_ptr<ASTNodeBase_exp>& argument_1,
      const std::string& argument_2);

  std::shared_ptr<ASTNodeGeneral_95_immutable> ReduceTo_ASTNodeGeneral_95_immutable_ViaItem_95(
      const std::shared_ptr<ASTNodeGeneral_97_call>& argument_0);

  std::shared_ptr<ASTNodeGeneral_96_immutable> ReduceTo_ASTNodeGeneral_96_immutable_ViaItem_96(
      const std::shared_ptr<ASTNodeBase_constant>& argument_0);

  std::shared_ptr<ASTNodeGeneral_97_call> ReduceTo_ASTNodeGeneral_97_call_ViaItem_97(
      const std::string& argument_0,
      const std::string& argument_1,
      const std::shared_ptr<ASTNodeBase_args>& argument_2,
      const std::string& argument_3);

  std::shared_ptr<ASTNodeGeneral_98_args> ReduceTo_ASTNodeGeneral_98_args_ViaItem_98(
      const std::shared_ptr<ASTNodeBase_argList>& argument_0);

  std::shared_ptr<ASTNodeGeneral_99_args> ReduceTo_ASTNodeGeneral_99_args_ViaItem_99();

  std::shared_ptr<ASTNodeGeneral_100_argList> ReduceTo_ASTNodeGeneral_100_argList_ViaItem_100(
      const std::shared_ptr<ASTNodeBase_argList>& argument_0,
      const std::string& argument_1,
      const std::shared_ptr<ASTNodeBase_exp>& argument_2);

  std::shared_ptr<ASTNodeGeneral_101_argList> ReduceTo_ASTNodeGeneral_101_argList_ViaItem_101(
      const std::shared_ptr<ASTNodeBase_exp>& argument_0);

  std::shared_ptr<ASTNodeGeneral_102_constant> ReduceTo_ASTNodeGeneral_102_constant_ViaItem_102(
      const std::string& argument_0);

  std::shared_ptr<ASTNodeGeneral_103_constant> ReduceTo_ASTNodeGeneral_103_constant_ViaItem_103(
      const std::string& argument_0);

  std::shared_ptr<ASTNodeGeneral_104_constant> ReduceTo_ASTNodeGeneral_104_constant_ViaItem_104(
      const std::string& argument_0);

  std::shared_ptr<ASTNodeGeneral_105_constant> ReduceTo_ASTNodeGeneral_105_constant_ViaItem_105(
      const std::string& argument_0);

  std::shared_ptr<ASTNodeGeneral_106_constant> ReduceTo_ASTNodeGeneral_106_constant_ViaItem_106(
      const std::string& argument_0);
};
...
inline std::shared_ptr<ASTNodeBase> Parser::reduce(
    unsigned reduction_id, const std::vector<std::shared_ptr<ASTNodeBase>>& collected_nodes) {
  switch (reduction_id) {
    case 0: {
    ...
    case 6: {
      ...
      LOG_SEV_TO(logger_, Debug)
          << "Calling reduce function 'ReduceTo_ASTNodeGeneral_6_scopedVarDecl_ViaItem_6'.";
    ...
    case 7: {
      ...
      LOG_SEV_TO(logger_, Debug)
          << "Calling reduce function 'ReduceTo_ASTNodeGeneral_7_scopedVarDecl_ViaItem_7'.";
    ...
    case 8: {
      ...
      LOG_SEV_TO(logger_, Debug)
          << "Calling reduce function 'ReduceTo_ASTNodeGeneral_8_varDeclList_ViaItem_8'.";
    ...
    case 9: {
      ...
      LOG_SEV_TO(logger_, Debug)
          << "Calling reduce function 'ReduceTo_ASTNodeGeneral_9_varDeclList_ViaItem_9'.";
    ...
    case 10: {
      ...
      LOG_SEV_TO(logger_, Debug)
          << "Calling reduce function 'ReduceTo_ASTNodeGeneral_10_varDeclInit_ViaItem_10'.";
    ...
    case 11: {
      ...
      LOG_SEV_TO(logger_, Debug)
          << "Calling reduce function 'ReduceTo_ASTNodeGeneral_11_varDeclInit_ViaItem_11'.";
    ...
    case 12: {
      ...
      LOG_SEV_TO(logger_, Debug)
          << "Calling reduce function 'ReduceTo_ASTNodeGeneral_12_varDeclId_ViaItem_12'.";
    ...
    case 13: {
      ...
      LOG_SEV_TO(logger_, Debug)
          << "Calling reduce function 'ReduceTo_ASTNodeGeneral_13_varDeclId_ViaItem_13'.";
    ...
    case 14: {
      ...
      LOG_SEV_TO(logger_, Debug)
          << "Calling reduce function 'ReduceTo_ASTNodeGeneral_14_typeSpec_ViaItem_14'.";
    ...
    case 15: {
      ...
      LOG_SEV_TO(logger_, Debug)
          << "Calling reduce function 'ReduceTo_ASTNodeGeneral_15_typeSpec_ViaItem_15'.";
    ...
    case 16: {
      ...
      LOG_SEV_TO(logger_, Debug)
          << "Calling reduce function 'ReduceTo_ASTNodeGeneral_16_typeSpec_ViaItem_16'.";
    ...
    case 17: {
      ...
      LOG_SEV_TO(logger_, Debug)
          << "Calling reduce function 'ReduceTo_ASTNodeGeneral_17_funDecl_ViaItem_17'.";
    ...
    case 18: {
      ...
      LOG_SEV_TO(logger_, Debug)
          << "Calling reduce function 'ReduceTo_ASTNodeGeneral_18_funDecl_ViaItem_18'.";
    ...
    case 21: {
      ...
      LOG_SEV_TO(logger_, Debug)
          << "Calling reduce function 'ReduceTo_ASTNodeGeneral_21_parmList_ViaItem_21'.";
    ...
    case 22: {
      ...
      LOG_SEV_TO(logger_, Debug)
          << "Calling reduce function 'ReduceTo_ASTNodeGeneral_22_parmList_ViaItem_22'.";
    ...
    case 23: {
      ...
      LOG_SEV_TO(logger_, Debug)
          << "Calling reduce function 'ReduceTo_ASTNodeGeneral_23_parmTypeList_ViaItem_23'.";
    ...
    case 24: {
      ...
      LOG_SEV_TO(logger_, Debug)
          << "Calling reduce function 'ReduceTo_ASTNodeGeneral_24_parmIdList_ViaItem_24'.";
    ...
    case 25: {
      ...
      LOG_SEV_TO(logger_, Debug)
          << "Calling reduce function 'ReduceTo_ASTNodeGeneral_25_parmIdList_ViaItem_25'.";
    ...
    case 34: {
      ...
      LOG_SEV_TO(logger_, Debug)
          << "Calling reduce function 'ReduceTo_ASTNodeGeneral_34_expStmt_ViaItem_34'.";
    ...
    case 35: {
      ...
      LOG_SEV_TO(logger_, Debug)
          << "Calling reduce function 'ReduceTo_ASTNodeGeneral_35_expStmt_ViaItem_35'.";
    ...
    case 36: {
      ...
      LOG_SEV_TO(logger_, Debug)
          << "Calling reduce function 'ReduceTo_ASTNodeGeneral_36_compoundStmt_ViaItem_36'.";
    ...
    case 37: {
      ...
      LOG_SEV_TO(logger_, Debug)
          << "Calling reduce function 'ReduceTo_ASTNodeGeneral_37_localDecls_ViaItem_37'.";
    ...
    case 38: {
      ...
      LOG_SEV_TO(logger_, Debug)
          << "Calling reduce function 'ReduceTo_ASTNodeGeneral_38_localDecls_ViaItem_38'.";
      return ReduceTo_ASTNodeGeneral_38_localDecls_ViaItem_38();
    }
    case 39: {
      REDUCE_ASSERT(2, 39, collected_nodes.size());
      LOG_SEV_TO(logger_, Debug)
          << "Calling reduce function 'ReduceTo_ASTNodeGeneral_39_stmtList_ViaItem_39'.";
    ...
    case 40: {
      ...
      LOG_SEV_TO(logger_, Debug)
          << "Calling reduce function 'ReduceTo_ASTNodeGeneral_40_stmtList_ViaItem_40'.";
      return ReduceTo_ASTNodeGeneral_40_stmtList_ViaItem_40();
    }
    case 41: {
      REDUCE_ASSERT(4, 41, collected_nodes.size());
      LOG_SEV_TO(logger_, Debug)
          << "Calling reduce function 'ReduceTo_ASTNodeGeneral_41_selectStmt_ViaItem_41'.";
    ...
    case 42: {
      ...
      LOG_SEV_TO(logger_, Debug)
          << "Calling reduce function 'ReduceTo_ASTNodeGeneral_42_selectStmt_ViaItem_42'.";
    ...
    case 43: {
      ...
      LOG_SEV_TO(logger_, Debug)
          << "Calling reduce function 'ReduceTo_ASTNodeGeneral_43_iterStmt_ViaItem_43'.";
    ...
    case 44: {
      ...
      LOG_SEV_TO(logger_, Debug)
          << "Calling reduce function 'ReduceTo_ASTNodeGeneral_44_iterStmt_ViaItem_44'.";
    ...
    case 45: {
      ...
      LOG_SEV_TO(logger_, Debug)
          << "Calling reduce function 'ReduceTo_ASTNodeGeneral_45_iterRange_ViaItem_45'.";
    ...
    case 46: {
      ...
      LOG_SEV_TO(logger_, Debug)
          << "Calling reduce function 'ReduceTo_ASTNodeGeneral_46_iterRange_ViaItem_46'.";
    ...
    case 47: {
      ...
      LOG_SEV_TO(logger_, Debug)
          << "Calling reduce function 'ReduceTo_ASTNodeGeneral_47_returnStmt_ViaItem_47'.";
    ...
    case 48: {
      ...
      LOG_SEV_TO(logger_, Debug)
          << "Calling reduce function 'ReduceTo_ASTNodeGeneral_48_returnStmt_ViaItem_48'.";
    ...
    case 49: {
      ...
      LOG_SEV_TO(logger_, Debug)
          << "Calling reduce function 'ReduceTo_ASTNodeGeneral_49_breakStmt_ViaItem_49'.";
    ...
    case 58: {
      ...
      LOG_SEV_TO(logger_, Debug)
          << "Calling reduce function 'ReduceTo_ASTNodeGeneral_58_simpleExp_ViaItem_58'.";
    ...
    case 59: {
      ...
      LOG_SEV_TO(logger_, Debug)
          << "Calling reduce function 'ReduceTo_ASTNodeGeneral_59_simpleExp_ViaItem_59'.";
    ...
    case 62: {
      ...
      LOG_SEV_TO(logger_, Debug)
          << "Calling reduce function 'ReduceTo_ASTNodeGeneral_62_unaryRelExp_ViaItem_62'.";
    ...
    case 63: {
      ...
      LOG_SEV_TO(logger_, Debug)
          << "Calling reduce function 'ReduceTo_ASTNodeGeneral_63_unaryRelExp_ViaItem_63'.";
    ...
    case 72: {
      ...
      LOG_SEV_TO(logger_, Debug)
          << "Calling reduce function 'ReduceTo_ASTNodeGeneral_72_minmaxExp_ViaItem_72'.";
    ...
    case 73: {
      ...
      LOG_SEV_TO(logger_, Debug)
          << "Calling reduce function 'ReduceTo_ASTNodeGeneral_73_minmaxExp_ViaItem_73'.";
    ...
    case 74: {
      ...
      LOG_SEV_TO(logger_, Debug)
          << "Calling reduce function 'ReduceTo_ASTNodeGeneral_74_minmaxop_ViaItem_74'.";
    ...
    case 75: {
      ...
      LOG_SEV_TO(logger_, Debug)
          << "Calling reduce function 'ReduceTo_ASTNodeGeneral_75_minmaxop_ViaItem_75'.";
    ...
    case 85: {
      ...
      LOG_SEV_TO(logger_, Debug)
          << "Calling reduce function 'ReduceTo_ASTNodeGeneral_85_unaryExp_ViaItem_85'.";
    ...
    case 86: {
      ...
      LOG_SEV_TO(logger_, Debug)
          << "Calling reduce function 'ReduceTo_ASTNodeGeneral_86_unaryExp_ViaItem_86'.";
    ...
    case 87: {
      ...
      LOG_SEV_TO(logger_, Debug)
          << "Calling reduce function 'ReduceTo_ASTNodeGeneral_87_unaryop_ViaItem_87'.";
    ...
    case 88: {
      ...
      LOG_SEV_TO(logger_, Debug)
          << "Calling reduce function 'ReduceTo_ASTNodeGeneral_88_unaryop_ViaItem_88'.";
    ...
    case 89: {
      ...
      LOG_SEV_TO(logger_, Debug)
          << "Calling reduce function 'ReduceTo_ASTNodeGeneral_89_unaryop_ViaItem_89'.";
    ...
    case 92: {
      ...
      LOG_SEV_TO(logger_, Debug)
          << "Calling reduce function 'ReduceTo_ASTNodeGeneral_92_mutable_ViaItem_92'.";
    ...
    case 93: {
      ...
      LOG_SEV_TO(logger_, Debug)
          << "Calling reduce function 'ReduceTo_ASTNodeGeneral_93_mutable_ViaItem_93'.";
    ...
    case 94: {
      ...
      LOG_SEV_TO(logger_, Debug)
          << "Calling reduce function 'ReduceTo_ASTNodeGeneral_94_immutable_ViaItem_94'.";
    ...
    case 95: {
      ...
      LOG_SEV_TO(logger_, Debug)
          << "Calling reduce function 'ReduceTo_ASTNodeGeneral_95_immutable_ViaItem_95'.";
    ...
    case 96: {
      ...
      LOG_SEV_TO(logger_, Debug)
          << "Calling reduce function 'ReduceTo_ASTNodeGeneral_96_immutable_ViaItem_96'.";
    ...
    case 100: {
      ...
      LOG_SEV_TO(logger_, Debug)
          << "Calling reduce function 'ReduceTo_ASTNodeGeneral_100_argList_ViaItem_100'.";
    ...
    case 101: {
      ...
      LOG_SEV_TO(logger_, Debug)
          << "Calling reduce function 'ReduceTo_ASTNodeGeneral_101_argList_ViaItem_101'.";
    ...
    case 102: {
      ...
      LOG_SEV_TO(logger_, Debug)
          << "Calling reduce function 'ReduceTo_ASTNodeGeneral_102_constant_ViaItem_102'.";
    ...
    case 103: {
      ...
      LOG_SEV_TO(logger_, Debug)
          << "Calling reduce function 'ReduceTo_ASTNodeGeneral_103_constant_ViaItem_103'.";
    ...
    case 104: {
      ...
      LOG_SEV_TO(logger_, Debug)
          << "Calling reduce function 'ReduceTo_ASTNodeGeneral_104_constant_ViaItem_104'.";
    ...
    case 105: {
      ...
      LOG_SEV_TO(logger_, Debug)
          << "Calling reduce function 'ReduceTo_ASTNodeGeneral_105_constant_ViaItem_105'.";
    ...
    case 106: {
      ...
      LOG_SEV_TO(logger_, Debug)
          << "Calling reduce function 'ReduceTo_ASTNodeGeneral_106_constant_ViaItem_106'.";
...
inline std::shared_ptr<ASTNodeGeneral_0_program> Parser::ReduceTo_ASTNodeGeneral_0_program_ViaItem_0(
...
inline std::shared_ptr<ASTNodeGeneral_1_declList> Parser::ReduceTo_ASTNodeGeneral_1_declList_ViaItem_1(
    [[maybe_unused]] const std::shared_ptr<ASTNodeBase_declList>& argument_0,
...
inline std::shared_ptr<ASTNodeGeneral_2_declList> Parser::ReduceTo_ASTNodeGeneral_2_declList_ViaItem_2(
...
inline std::shared_ptr<ASTNodeGeneral_3_decl> Parser::ReduceTo_ASTNodeGeneral_3_decl_ViaItem_3(
...
inline std::shared_ptr<ASTNodeGeneral_4_decl> Parser::ReduceTo_ASTNodeGeneral_4_decl_ViaItem_4(
...
inline std::shared_ptr<ASTNodeGeneral_5_varDecl> Parser::ReduceTo_ASTNodeGeneral_5_varDecl_ViaItem_5(
...
inline std::shared_ptr<ASTNodeGeneral_8_varDeclList> Parser::ReduceTo_ASTNodeGeneral_8_varDeclList_ViaItem_8(
...
inline std::shared_ptr<ASTNodeGeneral_9_varDeclList> Parser::ReduceTo_ASTNodeGeneral_9_varDeclList_ViaItem_9(
...
inline std::shared_ptr<ASTNodeGeneral_12_varDeclId> Parser::ReduceTo_ASTNodeGeneral_12_varDeclId_ViaItem_12(
    [[maybe_unused]] const std::string& argument_0) {
...
inline std::shared_ptr<ASTNodeGeneral_13_varDeclId> Parser::ReduceTo_ASTNodeGeneral_13_varDeclId_ViaItem_13(
    [[maybe_unused]] const std::string& argument_0,
    [[maybe_unused]] const std::string& argument_1,
    [[maybe_unused]] const std::string& argument_2,
    [[maybe_unused]] const std::string& argument_3) {
...
inline std::shared_ptr<ASTNodeGeneral_14_typeSpec> Parser::ReduceTo_ASTNodeGeneral_14_typeSpec_ViaItem_14(
    [[maybe_unused]] const std::string& argument_0) {
  return std::make_shared<ASTNodeGeneral_14_typeSpec>(14);
}

inline std::shared_ptr<ASTNodeGeneral_15_typeSpec> Parser::ReduceTo_ASTNodeGeneral_15_typeSpec_ViaItem_15(
    [[maybe_unused]] const std::string& argument_0) {
  return std::make_shared<ASTNodeGeneral_15_typeSpec>(15);
}

inline std::shared_ptr<ASTNodeGeneral_16_typeSpec> Parser::ReduceTo_ASTNodeGeneral_16_typeSpec_ViaItem_16(
    [[maybe_unused]] const std::string& argument_0) {
  return std::make_shared<ASTNodeGeneral_16_typeSpec>(16);
}

inline std::shared_ptr<ASTNodeGeneral_17_funDecl> Parser::ReduceTo_ASTNodeGeneral_17_funDecl_ViaItem_17(
    [[maybe_unused]] const std::shared_ptr<ASTNodeBase_typeSpec>& argument_0,
    [[maybe_unused]] const std::string& argument_1,
    [[maybe_unused]] const std::string& argument_2,
...
inline std::shared_ptr<ASTNodeGeneral_18_funDecl> Parser::ReduceTo_ASTNodeGeneral_18_funDecl_ViaItem_18(
    [[maybe_unused]] const std::string& argument_0,
    [[maybe_unused]] const std::string& argument_1,
...
inline std::shared_ptr<ASTNodeGeneral_19_parms> Parser::ReduceTo_ASTNodeGeneral_19_parms_ViaItem_19(
...
inline std::shared_ptr<ASTNodeGeneral_20_parms> Parser::ReduceTo_ASTNodeGeneral_20_parms_ViaItem_20() {
  return std::make_shared<ASTNodeGeneral_20_parms>(20);
}

inline std::shared_ptr<ASTNodeGeneral_21_parmList> Parser::ReduceTo_ASTNodeGeneral_21_parmList_ViaItem_21(
    [[maybe_unused]] const std::shared_ptr<ASTNodeBase_parmList>& argument_0,
    [[maybe_unused]] const std::string& argument_1,
...
inline std::shared_ptr<ASTNodeGeneral_22_parmList> Parser::ReduceTo_ASTNodeGeneral_22_parmList_ViaItem_22(
...
inline std::shared_ptr<ASTNodeGeneral_24_parmIdList> Parser::ReduceTo_ASTNodeGeneral_24_parmIdList_ViaItem_24(
...
inline std::shared_ptr<ASTNodeGeneral_25_parmIdList> Parser::ReduceTo_ASTNodeGeneral_25_parmIdList_ViaItem_25(
...
inline std::shared_ptr<ASTNodeGeneral_26_parmId> Parser::ReduceTo_ASTNodeGeneral_26_parmId_ViaItem_26(
    [[maybe_unused]] const std::string& argument_0) {
...
inline std::shared_ptr<ASTNodeGeneral_27_parmId> Parser::ReduceTo_ASTNodeGeneral_27_parmId_ViaItem_27(
    [[maybe_unused]] const std::string& argument_0,
    [[maybe_unused]] const std::string& argument_1,
    [[maybe_unused]] const std::string& argument_2) {
...
inline std::shared_ptr<ASTNodeGeneral_28_stmt> Parser::ReduceTo_ASTNodeGeneral_28_stmt_ViaItem_28(
...
inline std::shared_ptr<ASTNodeGeneral_29_stmt> Parser::ReduceTo_ASTNodeGeneral_29_stmt_ViaItem_29(
...
inline std::shared_ptr<ASTNodeGeneral_30_stmt> Parser::ReduceTo_ASTNodeGeneral_30_stmt_ViaItem_30(
...
inline std::shared_ptr<ASTNodeGeneral_31_stmt> Parser::ReduceTo_ASTNodeGeneral_31_stmt_ViaItem_31(
...
inline std::shared_ptr<ASTNodeGeneral_32_stmt> Parser::ReduceTo_ASTNodeGeneral_32_stmt_ViaItem_32(
...
inline std::shared_ptr<ASTNodeGeneral_33_stmt> Parser::ReduceTo_ASTNodeGeneral_33_stmt_ViaItem_33(
...
inline std::shared_ptr<ASTNodeGeneral_34_expStmt> Parser::ReduceTo_ASTNodeGeneral_34_expStmt_ViaItem_34(
...
inline std::shared_ptr<ASTNodeGeneral_35_expStmt> Parser::ReduceTo_ASTNodeGeneral_35_expStmt_ViaItem_35(
    [[maybe_unused]] const std::string& argument_0) {
...
inline std::shared_ptr<ASTNodeGeneral_37_localDecls> Parser::ReduceTo_ASTNodeGeneral_37_localDecls_ViaItem_37(
...
inline std::shared_ptr<ASTNodeGeneral_39_stmtList> Parser::ReduceTo_ASTNodeGeneral_39_stmtList_ViaItem_39(
...
inline std::shared_ptr<ASTNodeGeneral_40_stmtList> Parser::ReduceTo_ASTNodeGeneral_40_stmtList_ViaItem_40() {
  return std::make_shared<ASTNodeGeneral_40_stmtList>(40);
}

inline std::shared_ptr<ASTNodeGeneral_41_selectStmt> Parser::ReduceTo_ASTNodeGeneral_41_selectStmt_ViaItem_41(
    [[maybe_unused]] const std::string& argument_0,
...
inline std::shared_ptr<ASTNodeGeneral_42_selectStmt> Parser::ReduceTo_ASTNodeGeneral_42_selectStmt_ViaItem_42(
    [[maybe_unused]] const std::string& argument_0,
    [[maybe_unused]] const std::shared_ptr<ASTNodeBase_simpleExp>& argument_1,
    [[maybe_unused]] const std::string& argument_2,
    [[maybe_unused]] const std::shared_ptr<ASTNodeBase_stmt>& argument_3,
...
inline std::shared_ptr<ASTNodeGeneral_43_iterStmt> Parser::ReduceTo_ASTNodeGeneral_43_iterStmt_ViaItem_43(
    [[maybe_unused]] const std::string& argument_0,
    [[maybe_unused]] const std::shared_ptr<ASTNodeBase_simpleExp>& argument_1,
    [[maybe_unused]] const std::string& argument_2,
    [[maybe_unused]] const std::shared_ptr<ASTNodeBase_stmt>& argument_3) {
...
inline std::shared_ptr<ASTNodeGeneral_44_iterStmt> Parser::ReduceTo_ASTNodeGeneral_44_iterStmt_ViaItem_44(
    [[maybe_unused]] const std::string& argument_0,
    [[maybe_unused]] const std::string& argument_1,
    [[maybe_unused]] const std::string& argument_2,
...
inline std::shared_ptr<ASTNodeGeneral_45_iterRange> Parser::ReduceTo_ASTNodeGeneral_45_iterRange_ViaItem_45(
...
inline std::shared_ptr<ASTNodeGeneral_46_iterRange> Parser::ReduceTo_ASTNodeGeneral_46_iterRange_ViaItem_46(
    [[maybe_unused]] const std::shared_ptr<ASTNodeBase_simpleExp>& argument_0,
    [[maybe_unused]] const std::string& argument_1,
    [[maybe_unused]] const std::shared_ptr<ASTNodeBase_simpleExp>& argument_2,
    [[maybe_unused]] const std::string& argument_3,
...
inline std::shared_ptr<ASTNodeGeneral_47_returnStmt> Parser::ReduceTo_ASTNodeGeneral_47_returnStmt_ViaItem_47(
    [[maybe_unused]] const std::string& argument_0, [[maybe_unused]] const std::string& argument_1) {
  return std::make_shared<ASTNodeGeneral_47_returnStmt>(47);
}

inline std::shared_ptr<ASTNodeGeneral_48_returnStmt> Parser::ReduceTo_ASTNodeGeneral_48_returnStmt_ViaItem_48(
    [[maybe_unused]] const std::string& argument_0,
...
inline std::shared_ptr<ASTNodeGeneral_49_breakStmt> Parser::ReduceTo_ASTNodeGeneral_49_breakStmt_ViaItem_49(
    [[maybe_unused]] const std::string& argument_0, [[maybe_unused]] const std::string& argument_1) {
  return std::make_shared<ASTNodeGeneral_49_breakStmt>(49);
}

inline std::shared_ptr<ASTNodeGeneral_50_exp> Parser::ReduceTo_ASTNodeGeneral_50_exp_ViaItem_50(
...
inline std::shared_ptr<ASTNodeGeneral_51_exp> Parser::ReduceTo_ASTNodeGeneral_51_exp_ViaItem_51(
    [[maybe_unused]] const std::shared_ptr<ASTNodeBase_mutable>& argument_0,
    [[maybe_unused]] const std::string& argument_1,
    [[maybe_unused]] const std::shared_ptr<ASTNodeBase_exp>& argument_2) {
...
inline std::shared_ptr<ASTNodeGeneral_52_exp> Parser::ReduceTo_ASTNodeGeneral_52_exp_ViaItem_52(
    [[maybe_unused]] const std::shared_ptr<ASTNodeBase_mutable>& argument_0,
    [[maybe_unused]] const std::string& argument_1,
    [[maybe_unused]] const std::shared_ptr<ASTNodeBase_exp>& argument_2) {
...
inline std::shared_ptr<ASTNodeGeneral_53_exp> Parser::ReduceTo_ASTNodeGeneral_53_exp_ViaItem_53(
    [[maybe_unused]] const std::shared_ptr<ASTNodeBase_mutable>& argument_0,
    [[maybe_unused]] const std::string& argument_1,
    [[maybe_unused]] const std::shared_ptr<ASTNodeBase_exp>& argument_2) {
...
inline std::shared_ptr<ASTNodeGeneral_54_exp> Parser::ReduceTo_ASTNodeGeneral_54_exp_ViaItem_54(
    [[maybe_unused]] const std::shared_ptr<ASTNodeBase_mutable>& argument_0,
    [[maybe_unused]] const std::string& argument_1,
    [[maybe_unused]] const std::shared_ptr<ASTNodeBase_exp>& argument_2) {
...
inline std::shared_ptr<ASTNodeGeneral_55_exp> Parser::ReduceTo_ASTNodeGeneral_55_exp_ViaItem_55(
    [[maybe_unused]] const std::shared_ptr<ASTNodeBase_mutable>& argument_0,
    [[maybe_unused]] const std::string& argument_1) {
...
inline std::shared_ptr<ASTNodeGeneral_56_exp> Parser::ReduceTo_ASTNodeGeneral_56_exp_ViaItem_56(
    [[maybe_unused]] const std::shared_ptr<ASTNodeBase_mutable>& argument_0,
    [[maybe_unused]] const std::string& argument_1) {
...
inline std::shared_ptr<ASTNodeGeneral_57_exp> Parser::ReduceTo_ASTNodeGeneral_57_exp_ViaItem_57(
    [[maybe_unused]] const std::shared_ptr<ASTNodeBase_simpleExp>& argument_0) {
...
inline std::shared_ptr<ASTNodeGeneral_58_simpleExp> Parser::ReduceTo_ASTNodeGeneral_58_simpleExp_ViaItem_58(
    [[maybe_unused]] const std::shared_ptr<ASTNodeBase_simpleExp>& argument_0,
    [[maybe_unused]] const std::string& argument_1,
...
inline std::shared_ptr<ASTNodeGeneral_59_simpleExp> Parser::ReduceTo_ASTNodeGeneral_59_simpleExp_ViaItem_59(
...
inline std::shared_ptr<ASTNodeGeneral_60_andExp> Parser::ReduceTo_ASTNodeGeneral_60_andExp_ViaItem_60(
    [[maybe_unused]] const std::shared_ptr<ASTNodeBase_andExp>& argument_0,
    [[maybe_unused]] const std::string& argument_1,
...
inline std::shared_ptr<ASTNodeGeneral_61_andExp> Parser::ReduceTo_ASTNodeGeneral_61_andExp_ViaItem_61(
...
inline std::shared_ptr<ASTNodeGeneral_64_relExp> Parser::ReduceTo_ASTNodeGeneral_64_relExp_ViaItem_64(
...
inline std::shared_ptr<ASTNodeGeneral_65_relExp> Parser::ReduceTo_ASTNodeGeneral_65_relExp_ViaItem_65(
    [[maybe_unused]] const std::shared_ptr<ASTNodeBase_minmaxExp>& argument_0) {
...
inline std::shared_ptr<ASTNodeGeneral_66_relop> Parser::ReduceTo_ASTNodeGeneral_66_relop_ViaItem_66(
    [[maybe_unused]] const std::string& argument_0) {
  return std::make_shared<ASTNodeGeneral_66_relop>(66);
}

inline std::shared_ptr<ASTNodeGeneral_67_relop> Parser::ReduceTo_ASTNodeGeneral_67_relop_ViaItem_67(
    [[maybe_unused]] const std::string& argument_0) {
  return std::make_shared<ASTNodeGeneral_67_relop>(67);
}

inline std::shared_ptr<ASTNodeGeneral_68_relop> Parser::ReduceTo_ASTNodeGeneral_68_relop_ViaItem_68(
    [[maybe_unused]] const std::string& argument_0) {
  return std::make_shared<ASTNodeGeneral_68_relop>(68);
}

inline std::shared_ptr<ASTNodeGeneral_69_relop> Parser::ReduceTo_ASTNodeGeneral_69_relop_ViaItem_69(
    [[maybe_unused]] const std::string& argument_0) {
  return std::make_shared<ASTNodeGeneral_69_relop>(69);
}

inline std::shared_ptr<ASTNodeGeneral_70_relop> Parser::ReduceTo_ASTNodeGeneral_70_relop_ViaItem_70(
    [[maybe_unused]] const std::string& argument_0) {
  return std::make_shared<ASTNodeGeneral_70_relop>(70);
}

inline std::shared_ptr<ASTNodeGeneral_71_relop> Parser::ReduceTo_ASTNodeGeneral_71_relop_ViaItem_71(
    [[maybe_unused]] const std::string& argument_0) {
  return std::make_shared<ASTNodeGeneral_71_relop>(71);
}

inline std::shared_ptr<ASTNodeGeneral_72_minmaxExp> Parser::ReduceTo_ASTNodeGeneral_72_minmaxExp_ViaItem_72(
    [[maybe_unused]] const std::shared_ptr<ASTNodeBase_minmaxExp>& argument_0,
...
inline std::shared_ptr<ASTNodeGeneral_73_minmaxExp> Parser::ReduceTo_ASTNodeGeneral_73_minmaxExp_ViaItem_73(
...
inline std::shared_ptr<ASTNodeGeneral_74_minmaxop> Parser::ReduceTo_ASTNodeGeneral_74_minmaxop_ViaItem_74(
    [[maybe_unused]] const std::string& argument_0) {
  return std::make_shared<ASTNodeGeneral_74_minmaxop>(74);
}

inline std::shared_ptr<ASTNodeGeneral_75_minmaxop> Parser::ReduceTo_ASTNodeGeneral_75_minmaxop_ViaItem_75(
    [[maybe_unused]] const std::string& argument_0) {
  return std::make_shared<ASTNodeGeneral_75_minmaxop>(75);
}

inline std::shared_ptr<ASTNodeGeneral_76_sumExp> Parser::ReduceTo_ASTNodeGeneral_76_sumExp_ViaItem_76(
    [[maybe_unused]] const std::shared_ptr<ASTNodeBase_sumExp>& argument_0,
...
inline std::shared_ptr<ASTNodeGeneral_77_sumExp> Parser::ReduceTo_ASTNodeGeneral_77_sumExp_ViaItem_77(
...
inline std::shared_ptr<ASTNodeGeneral_78_sumop> Parser::ReduceTo_ASTNodeGeneral_78_sumop_ViaItem_78(
    [[maybe_unused]] const std::string& argument_0) {
  return std::make_shared<ASTNodeGeneral_78_sumop>(78);
}

inline std::shared_ptr<ASTNodeGeneral_79_sumop> Parser::ReduceTo_ASTNodeGeneral_79_sumop_ViaItem_79(
    [[maybe_unused]] const std::string& argument_0) {
  return std::make_shared<ASTNodeGeneral_79_sumop>(79);
}

inline std::shared_ptr<ASTNodeGeneral_80_mulExp> Parser::ReduceTo_ASTNodeGeneral_80_mulExp_ViaItem_80(
    [[maybe_unused]] const std::shared_ptr<ASTNodeBase_mulExp>& argument_0,
...
inline std::shared_ptr<ASTNodeGeneral_81_mulExp> Parser::ReduceTo_ASTNodeGeneral_81_mulExp_ViaItem_81(
...
inline std::shared_ptr<ASTNodeGeneral_82_mulop> Parser::ReduceTo_ASTNodeGeneral_82_mulop_ViaItem_82(
    [[maybe_unused]] const std::string& argument_0) {
  return std::make_shared<ASTNodeGeneral_82_mulop>(82);
}

inline std::shared_ptr<ASTNodeGeneral_83_mulop> Parser::ReduceTo_ASTNodeGeneral_83_mulop_ViaItem_83(
    [[maybe_unused]] const std::string& argument_0) {
  return std::make_shared<ASTNodeGeneral_83_mulop>(83);
}

inline std::shared_ptr<ASTNodeGeneral_84_mulop> Parser::ReduceTo_ASTNodeGeneral_84_mulop_ViaItem_84(
    [[maybe_unused]] const std::string& argument_0) {
  return std::make_shared<ASTNodeGeneral_84_mulop>(84);
}

inline std::shared_ptr<ASTNodeGeneral_85_unaryExp> Parser::ReduceTo_ASTNodeGeneral_85_unaryExp_ViaItem_85(
...
inline std::shared_ptr<ASTNodeGeneral_86_unaryExp> Parser::ReduceTo_ASTNodeGeneral_86_unaryExp_ViaItem_86(
...
inline std::shared_ptr<ASTNodeGeneral_87_unaryop> Parser::ReduceTo_ASTNodeGeneral_87_unaryop_ViaItem_87(
    [[maybe_unused]] const std::string& argument_0) {
  return std::make_shared<ASTNodeGeneral_87_unaryop>(87);
}

inline std::shared_ptr<ASTNodeGeneral_88_unaryop> Parser::ReduceTo_ASTNodeGeneral_88_unaryop_ViaItem_88(
    [[maybe_unused]] const std::string& argument_0) {
  return std::make_shared<ASTNodeGeneral_88_unaryop>(88);
}

inline std::shared_ptr<ASTNodeGeneral_89_unaryop> Parser::ReduceTo_ASTNodeGeneral_89_unaryop_ViaItem_89(
    [[maybe_unused]] const std::string& argument_0) {
  return std::make_shared<ASTNodeGeneral_89_unaryop>(89);
}

inline std::shared_ptr<ASTNodeGeneral_90_factor> Parser::ReduceTo_ASTNodeGeneral_90_factor_ViaItem_90(
...
inline std::shared_ptr<ASTNodeGeneral_91_factor> Parser::ReduceTo_ASTNodeGeneral_91_factor_ViaItem_91(
    [[maybe_unused]] const std::shared_ptr<ASTNodeBase_mutable>& argument_0) {
...
inline std::shared_ptr<ASTNodeGeneral_92_mutable> Parser::ReduceTo_ASTNodeGeneral_92_mutable_ViaItem_92(
    [[maybe_unused]] const std::string& argument_0) {
...
inline std::shared_ptr<ASTNodeGeneral_93_mutable> Parser::ReduceTo_ASTNodeGeneral_93_mutable_ViaItem_93(
    [[maybe_unused]] const std::string& argument_0,
    [[maybe_unused]] const std::string& argument_1,
    [[maybe_unused]] const std::shared_ptr<ASTNodeBase_exp>& argument_2,
    [[maybe_unused]] const std::string& argument_3) {
...
inline std::shared_ptr<ASTNodeGeneral_94_immutable> Parser::ReduceTo_ASTNodeGeneral_94_immutable_ViaItem_94(
    [[maybe_unused]] const std::string& argument_0,
    [[maybe_unused]] const std::shared_ptr<ASTNodeBase_exp>& argument_1,
    [[maybe_unused]] const std::string& argument_2) {
...
inline std::shared_ptr<ASTNodeGeneral_95_immutable> Parser::ReduceTo_ASTNodeGeneral_95_immutable_ViaItem_95(
...
inline std::shared_ptr<ASTNodeGeneral_96_immutable> Parser::ReduceTo_ASTNodeGeneral_96_immutable_ViaItem_96(
...
inline std::shared_ptr<ASTNodeGeneral_97_call> Parser::ReduceTo_ASTNodeGeneral_97_call_ViaItem_97(
    [[maybe_unused]] const std::string& argument_0,
    [[maybe_unused]] const std::string& argument_1,
...
inline std::shared_ptr<ASTNodeGeneral_98_args> Parser::ReduceTo_ASTNodeGeneral_98_args_ViaItem_98(
...
inline std::shared_ptr<ASTNodeGeneral_99_args> Parser::ReduceTo_ASTNodeGeneral_99_args_ViaItem_99() {
  return std::make_shared<ASTNodeGeneral_99_args>(99);
}

inline std::shared_ptr<ASTNodeGeneral_100_argList> Parser::ReduceTo_ASTNodeGeneral_100_argList_ViaItem_100(
    [[maybe_unused]] const std::shared_ptr<ASTNodeBase_argList>& argument_0,
    [[maybe_unused]] const std::string& argument_1,
    [[maybe_unused]] const std::shared_ptr<ASTNodeBase_exp>& argument_2) {
...
inline std::shared_ptr<ASTNodeGeneral_101_argList> Parser::ReduceTo_ASTNodeGeneral_101_argList_ViaItem_101(
    [[maybe_unused]] const std::shared_ptr<ASTNodeBase_exp>& argument_0) {
...
inline std::shared_ptr<ASTNodeGeneral_102_constant> Parser::ReduceTo_ASTNodeGeneral_102_constant_ViaItem_102(
    [[maybe_unused]] const std::string& argument_0) {
...
inline std::shared_ptr<ASTNodeGeneral_103_constant> Parser::ReduceTo_ASTNodeGeneral_103_constant_ViaItem_103(
    [[maybe_unused]] const std::string& argument_0) {
...
inline std::shared_ptr<ASTNodeGeneral_104_constant> Parser::ReduceTo_ASTNodeGeneral_104_constant_ViaItem_104(
    [[maybe_unused]] const std::string& argument_0) {
...
inline std::shared_ptr<ASTNodeGeneral_105_constant> Parser::ReduceTo_ASTNodeGeneral_105_constant_ViaItem_105(
    [[maybe_unused]] const std::string& argument_0) {
  return std::make_shared<ASTNodeGeneral_105_constant>(105);
}

inline std::shared_ptr<ASTNodeGeneral_106_constant> Parser::ReduceTo_ASTNodeGeneral_106_constant_ViaItem_106(
    [[maybe_unused]] const std::string& argument_0) {
